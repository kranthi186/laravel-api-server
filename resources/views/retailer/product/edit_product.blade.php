...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i> Edit <span class='fw-300'>Product</span>
    </h1>
</div>
<div class="row">
    <div class="col">
        <form method="post" action="/retailer_edit_product/{{$product->connection_id}}" enctype="multipart/form-data">
            @csrf
            <!-- Status -->
                ...
                <div class="panel-container show">
                    {{-- <form> --}}
                        <div class="panel-content">
                            ...
                            <!-- Pricing -->
                            <div class="form-group price_weight">
                                <label class="form-label" for="basic-url">Price per 1/4 gram</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">$</span>
                                    </div>
