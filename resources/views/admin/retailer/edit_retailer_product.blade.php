...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i> <span class='fw-300'>Update </span>Product <span class="fw-300">|</span><span class='fw-400 color-primary-500'> {{$retailer_name}}</span>
    </h1>
</div>
<!-- BEGIN ACTUAL PAGE CONTENT -->
<div class="row">
    <div class="col">
    <form method="post" action="/edit_retailer_product/{{$product->connection_id}}" enctype="multipart/form-data">
        @csrf
        <!-- Status -->
