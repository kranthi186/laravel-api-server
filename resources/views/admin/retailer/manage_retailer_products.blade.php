...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i> <span class='fw-300'>Manage </span>Products <span
            class="fw-300">|</span><span class='fw-400 color-primary-500'> Retailer Name</span>
    </h1>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div id="panel-4" class="panel">
            <div class="panel-hdr">
                <h2 class="m-2 ml-0">
                <a href="/add_retailer_product/{{$user->id}}"><button class="btn btn-success btn-block" tabindex="0"
...
<script>
    ...
    {   
        ...
        //     },
        // ];
        var types = ['indica', 'savita', 'hybrid', 'cbd'];
