...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">{{$retailer_name}}</li>
    <li class="breadcrumb-item active">Add Product</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
</ol>
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i> <span class='fw-300'>Add </span>Product <span class="fw-300">|</span><span class='fw-400 color-primary-500'> {{$retailer_name}}</span>
    </h1>
</div>
<!-- BEGIN ACTUAL PAGE CONTENT -->
<div class="row">
    <div class="col">
    <form method="post" action="/add_retailer_product/{{$user_id}}" enctype="multipart/form-data">
        @csrf
        <!-- Status -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="frame-wrap">
                                <div class="custom-control custom-radio custom-control-inline custom-radio-rounded">
                                    <input type="radio" class="custom-control-input" id="product-active" name="product_status" value="1" checked>
                                    <label class="custom-control-label" for="product-active"><span class="badge badge-success w-100">ACTIVE</span></label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline custom-radio-rounded">
                                    <input type="radio" class="custom-control-input" id="product-inactive" name="product_status" value="0">
                    ...
                    {{-- <form> --}}
                        ...
                        <div class="form-group">
	                        ...
	                        <div class="product_select_container">
	                            <select multiple class="form-control" id="retailer_product_select">
                        ...
                        <div class="form-group">
                            ...
                            <div class="frame-wrap">
                                <div class="custom-control custom-radio custom-control-inline custom-radio-rounded">
                                    <input type="radio" class="custom-control-input" id="popular-no" name="popular" value="0" checked>
                                    <label class="custom-control-label" for="popular-no"><span class="badge badge-danger w-100">NO</span></label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline custom-radio-rounded">
                                    <input type="radio" class="custom-control-input" id="popular-yes" name="popular" value="1">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group">
                        ...
                        <input id="demo_happy" type="text" value="" name="attr_happy" class="characteristic d-none form-control" tabindex="-1" readonly="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="form-group price_quantity">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="price_product" name="price_product" aria-label="Amount (to the nearest dollar)">
                            </div>
                        </div>
                        <!-- Pricing -->
                        <div class="form-group price_weight">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="price_half" name="price_half" aria-label="Amount (to the nearest dollar)">
                            </div>
                        </div>
                        <!-- Pricing -->
                        <div class="form-group price_weight">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="price_one" name="price_one" aria-label="Amount (to the nearest dollar)">
                            </div>
                        </div>
                        <!-- Pricing -->
                        <div class="form-group price_weight">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="price_ounce" name="price_ounce" aria-label="Amount (to the nearest dollar)">
                            </div>
                        </div>
