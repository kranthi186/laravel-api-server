...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i> <span class='fw-300'>Edit</span> Article
    </h1>
</div>
<!-- BEGIN ACTUAL PAGE CONTENT -->
<div class="row">
    <div class="col">
        <form method="post" action="/edit_news/<?php echo $news->id ?>" enctype="multipart/form-data">
            @csrf
        <!-- Status -->
                            ...
                            <div class="frame-wrap">
                                <div class="custom-control custom-radio custom-control-inline custom-radio-rounded">
                                    <input type="radio" class="custom-control-input" id="news-active" value="1"
                                        name="news_status" <?php if($news->status == 1){echo 'checked';}?>>
                                ...
                                <div class="custom-control custom-radio custom-control-inline custom-radio-rounded">
                                    <input type="radio" class="custom-control-input" id="news-inactive" value="0"
                                        name="news_status" <?php if($news->status == 0){echo 'checked';}?>>
                    ...
                    {{-- <form> --}}
                        ...
                        <div class="form-group">
                            ...
                            <select id="news-category" class="custom-select form-control" name="news_category">
                                ...
                                <option value="0" <?php if($news->category == 0){echo 'selected';}?>>News</option>
                                <option value="1" <?php if($news->category == 1){echo 'selected';}?>>Update</option>
                                <option value="2" <?php if($news->category == 2){echo 'selected';}?>>General</option>
                            </select>
                        </div>
                        <!-- Name -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="link" class="form-control" name="link" value="{{$news->link}}">
                        </div>
                        <!-- Image -->
                        <div class="form-group">
                            ...
                            <div clas="form-control">
                                @if($news->photo != '')
                                    <img src="{{$news->photo}}" width="279" height="144" class="img-border preview_photo" />
                                @else
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="datetime-local" id="date" name="date" value="{{$news->date}}">
                        </div>
        ...
        <button class="btn btn-primary btn-block" type="submit">Update News Article</button>
    </form>
    </div>
