...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i> <span class='fw-300'>Add</span> Brand
    </h1>
</div>
                ...
                <div class="panel-content">
                    {{-- <form> --}}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="brand" class="form-control" name="name" value="<?php if( Session::get('data')){echo Session::get('data')['name'];} ?>">
                        </div>
                        <!-- Tagline -->
                        <div class="form-group">
                            <label class="form-label" for="tagline">Tagline</label>
                            <input type="text" id="tagline" class="form-control" name="tagline" value="<?php if( Session::get('data')){echo Session::get('data')['tagline'];} ?>">
                        </div>
                        <!-- Logo 128x128-->
                        <div class="form-group">
        ...
        <div class="marvel-device iphone-x">
            ...
            <div class="screen">
                <div class="screen-scroll">
                    <img src="img/brand-preview.svg" width="100%">
                </div>
