...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i> <span class='fw-300'>Add </span>Product <span class="fw-300">|</span><span class='fw-400 color-primary-500'> {{$brand_name}}</span>
    </h1>
</div>
<!-- BEGIN ACTUAL PAGE CONTENT -->
<div class="row">
    <div class="col">
    <form method="post" action="/add_brand_product/{{$user_id}}" enctype="multipart/form-data">
        @csrf
        <!-- Status -->
