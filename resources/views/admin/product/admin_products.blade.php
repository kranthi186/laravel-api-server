...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-edit'></i> <span class='fw-300'>Manage</span> Products
    </h1>
</div>
<div class="row">
    <div class="col-lg-12">
        <div id="panel-4" class="panel">
            <div class="panel-hdr">
                <h2 class="m-2 ml-0">
                <a href="/admin_add_product"><button class="btn btn-primary btn-block" tabindex="0" aria-controls="dt-basic-example" type="button"><span><i class="fal fa-plus mr-1"></i> Add Product</span></button></a>
                </h2>
            </div>
        ...
        $('#products-list').dataTable(
        {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta)
                    {
                        return "\n\t\t\t\t\t\t<div class=\"dt-buttons\"><a href=\"/delete_product/" + full['id'] + "\">\n\t\t\t\t\t\t<button class=\"btn buttons-selected btn-primary btn-block mr-1\" tabindex=\"0\" aria-controls=\"brands-list\" type=\"button\">\n\t\t\t\t\t\t<span>\n\t\t\t\t\t\t<i class=\"fal fa-trash mr-1\">\n\t\t\t\t\t\t</i>\n\t\t\t\t\t\t Delete</span>\n\t\t\t\t\t\t</button>\n\t\t\t\t\t\t</a>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t";
                    },
                },
            ],
            responsive: true,
